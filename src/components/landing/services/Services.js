...
const Services = () => {
  return (
    <div
      className=" flex-wrap-reverse md:flex  items-center justify-around mt-20 lg:ml-10 bg-blue-50 lg:bg-white overflow-hidden"
      style={{
        zIndex: 50,
      }}
    >
      ...
      <div
        className="absolute bottom-20 left-10 opacity-50 hidden md:flex"
        style={{
          zIndex: 0,
        }}
      >
      ...
      <div
        className="absolute -bottom-20 left-20 overflow-hidden hidden md:flex"
        style={{
          zIndex: 0,
        }}
      >
      ...
      <div
        className="absolute -bottom-36 hidden md:flex"
        style={{
          zIndex: 0,
        }}
      >
      ...
      <div className="w-full md:w-3/4 p-4 flex flex-col items-center gap-10 overflow-x-auto relative">
        <div
          className="absolute top-16 left-0 w-full hidden lg:flex bg-blue-50  shadow-lg items-center justify-center "
          style={{
            zIndex: 0,
            height: "28rem",
        ...
        >
          <div className="flex items-center justify-center gap-4">
            <div className="flex items-center justify-center p-4  rounded-full shadow-lg"></div>
          </div>
        </div>

        <div
          className="flex w-full justify-between ml-72 sm:ml-0 "
          style={{
            minWidth: "600px",
            maxWidth: "750px",
            zIndex: 10,
        ...
        >
          <div
            className="flex flex-col items-center p-4 bg-white shadow-lg rounded-3xl justify-center"
            style={{
              height: "150px",
              width: "135px",
            }}
          >
            ...
            >
              ...
              >
                <path
                  fill="#FFA500"
                  d="M11 10.5h-1v3h1v-3zm-1-5h1v3h-1v-3zm5-5v3h-1v-3h1zm-1 5h1v3h-1v-3zm1 11h1v3h-1v-3zm-1-5h1v3h-1v-3zm-5-5h1v3h-1v-3zm-1 10.5h1v3h-1v-3zm1-5h1v3h-1v-3zm-5-5h1v3h-1v-3zm-1 10.5h1v3h-1v-3zm1-5h1v3h-1v-3zm-2 5h-1v-15h1v15zm-1 1h1v1h-1v-1zm0 2h1v1h-1v-1zm0 2h1v1h-1v-1zm1 1h-1v-1h1v1zm0-2h-1v-1h1v1zm0-2h-1v-1h1v1zm0-2h-1v-1h1v1zm1-1h-1v1h1v-1zm0 2h-1v1h1v-1zm0 2h-1v1h1v-1zm0 2h-1v1h1v-1zm-1 1h1v-1h-1v1zm0-2h1v-1h-1v1zm0-2h1v-1h-1v1zm0-2h1v-1h-1v1zm1-1h-1v1h1v-1zm0 2h-1v1h1v-1zm0 2h-1v1h1v-1zm0 2h-1v1h1v-1z"
                />
              </svg>
            </div>
          ...
          >
            ...
            >
              ...
              >
                <path
                  fill="#2ECC71"
                  d="M21.4545 5.81818C22.1875 5.81818 22.8182 6.44886 22.8182 7.18182V16.6364C22.8182 17.3694 22.1875 18 21.4545 18H17.4545V16.6364H21.4545V7.18182H2.54545V16.6364H6.54545V18H2.54545C1.8125 18 1.18182 17.3694 1.18182 16.6364V7.18182C1.18182 6.44886 1.8125 5.81818 2.54545 5.81818H6.54545V4.45455H2.54545C1.33999 4.45455 0.363281 5.43126 0.363281 6.63672V17.1818C0.363281 18.3873 1.33999 19.3639 2.54545 19.3639H21.4545C22.66 19.3639 23.6367 18.3873 23.6367 17.1818V6.63672C23.6367 5.43126 22.66 4.45455 21.4545 4.45455H17.4545V5.81818H21.4545ZM17.4545 16.6364H6.54545V7.18182H17.4545V16.6364ZM8.45459 9.18182H14.5455V10.5455H8.45459V9.18182ZM8.45459 11.9091H14.5455V13.2727H8.45459V11.9091ZM8.45459 14.6364H14.5455V16H8.45459V14.6364Z"
                />
              </svg>
            </div>
        ...
        <div
          className="flex w-full justify-between lg:-ml-28 md:flex-wrap ml-60 sm:ml-0 "
          style={{
            minWidth: "600px",
            maxWidth: "750px",
            zIndex: 10,
